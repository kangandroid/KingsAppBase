...
public class CreateVideoFragment extends CommonDialog {

    private Handler handler;
    private int waitSecond = 3;

    private CreateVideoFragment() {
    }

    private static CreateVideoFragment getInstance() {
        return InstanceHolder.instance;
    }

    public static void show(FragmentManager fg) {
        CreateVideoFragment instance = getInstance();
    ...
    private static class InstanceHolder {
        private static CreateVideoFragment instance = new CreateVideoFragment();
    }
