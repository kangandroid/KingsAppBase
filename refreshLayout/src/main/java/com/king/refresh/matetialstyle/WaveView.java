...
public class WaveView extends View implements ViewTreeObserver.OnPreDrawListener {
     ...
     * 影の色
     */
    private static final int SHADOW_COLOR = 0xcc000000;
    ...
    private Animator.AnimatorListener mDropListener;
    ...
    private void setUpPaint() {
        ...
        mShadowPaint.setShadowLayer(2*density, 0.0f, 2.0f, SHADOW_COLOR);
    }
    ...
    public void setmDropListener(Animator.AnimatorListener mDropListener) {
